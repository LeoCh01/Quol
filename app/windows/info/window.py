...
class MainWindow(CustomWindow):
    def __init__(self, wid, geometry=(10, 10, 180, 1)):
        ...
        self.key_label = QLabel(' Key = ' + str(self.config['toggle_key']))
        ...
        self.grid_layout.addWidget(self.key_label, 1, 0)
    ...
    def on_update_config(self):
        ...
        self.key_label.setText(' Key = ' + str(self.config['toggle_key']))
        self.toggle_startup()
